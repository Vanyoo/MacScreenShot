...
@class JTEditItem, JTUndoManager, NSColor, NSMutableArray, NSString, NSTrackingArea;

@interface JTEditView : NSView
{
    ...
    JTEditItem *_focusItem;
    NSString *_textItemContentBeforeEdit;
    JTUndoManager *_undoManager;
}

@property(retain, nonatomic) JTUndoManager *undoManager; // @synthesize undoManager=_undoManager;
...
@property(nonatomic) __weak JTEditItem *focusItem; // @synthesize focusItem=_focusItem;
