...
@interface JTPopoverLineColorView : NSView
{
    id <JTPopoverLineColorViewDelegate> _delegate;
...
@property(nonatomic) __weak id <JTPopoverLineColorViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
